...
db.post.belongsTo(db.user, { foreignKey: { name: "user_id"} , onDelete: 'CASCADE', onUpdate: 'CASCADE'});
db.comment.belongsTo(db.post, {foreignKey: {name: "post_id"}, onDelete: 'CASCADE', onUpdate: 'CASCADE'});
db.comment.belongsTo(db.user, { foreignKey: { name: "user_id"}, onDelete: 'CASCADE', onUpdate: 'CASCADE' });
db.sub_comment.belongsTo(db.comment, {foreignKey: {name:"comment_id"}, onDelete: 'CASCADE', onUpdate: 'CASCADE'});
db.sub_comment.belongsTo(db.user, { foreignKey: { name: "user_id"} , onDelete: 'CASCADE', onUpdate: 'CASCADE'});
